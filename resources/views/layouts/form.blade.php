        ...
        <div class="row align-items-center justify-content-xl-between">
          ...
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
              <li class="nav-item">
                <a href="https://www.segurosocial.app/site/mx/inst/salud/salud.php?NINSTI=11&ID=17893&NESTADO=20&NMUNICIP=429" class="nav-link" target="_blank">¿Quienes Somos?</a>
              </li>
